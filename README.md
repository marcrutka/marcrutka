...
- 💻 I specialize in Machine Learning using Python (Pandas, Scikit-learn,Tensorflow,PyTorch,Kafka etc.) and have solid experience Oracle Apex.
  
- 📊 I also enjoy crafting insightful data visualizations and preparing datasets using R tools like dplyr, shiny, plotly, and ggplot2.
